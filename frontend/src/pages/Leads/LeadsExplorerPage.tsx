...
const LeadsExplorerPage: React.FC = () => {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", `Umang_Leads_${bucket}_${new Date().toISOString().split('T')[0]}.csv`);
                      ...
                      >
                        ...
                        <td className="px-6 py-6 text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <button onClick={(e) => { e.stopPropagation(); navigate('/leads/' + lead.id); }} className="p-2 rounded-lg bg-zinc-100 dark:bg-zinc-900 text-zinc-500 hover:text-teal-500 transition-colors">
