...
- [GitHub Security Advisories](https://github.com/Kunalmishra77/WhatsApp-CRM/security/advisories/new)
...
In scope:
- Anything in this repository (`Kunalmishra77/WhatsApp-CRM`), including webhook and auth
